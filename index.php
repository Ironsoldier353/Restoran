                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <p class="text-white animated slideInLeft mb-4 pb-2">Indulge in a delightful dining experience with us. Whether you’re booking a table for a special occasion or craving delicious food delivered to your doorstep, we’re here to serve you the best. Your satisfaction, our priority—always! 🍽️✨</p>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">Where flavor meets excellence! At Restoran, we bring you the perfect blend of exquisite dining and unparalleled convenience. Whether you're reserving a table for a memorable evening or enjoying our seamless online food delivery, we ensure every experience is as delightful as the food itself.</p>
                        <p class="mb-4">Join us to indulge in delicious dishes, crafted with passion and served with care. Restoran is your destination for great taste, quality, and service!</p>
